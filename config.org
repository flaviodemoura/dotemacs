...
#+last_modified: [2023-10-03 ter 15:12]
...
#+BEGIN_SRC emacs-lisp
  (use-package org-ai
    ...
    :load-path (lambda () "/home/flaviomoura/.emacs.d/elpa/org-ai-20230330.2333")
    :custom
    (org-ai-openai-api-token "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")
    :init
  ...
  (defun org-ai-src-block ()
    (interactive)
    (insert "#+begin_ai \n\n#+end_ai"))

  (define-key org-mode-map (kbd "C-c s") #'org-ai-src-block)
  #+END_SRC
** General settings.
