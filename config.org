...
#+last_modified: [2021-01-17 Dom 11:25]
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-agenda-files (list "~/beorg/org/"
                               "~/beorg/orgOLD/"))
  ...
  (setq org-publish-project-alist
        '(("ensino"
           :base-directory "~/beorg/org/ensino"
           :base-extension "org"
           :publishing-directory "~/workspace-git/flaviodemoura.github.io/"
          ...
          ("images"
           ...
           :publishing-directory "~/workspace-git/flaviodemoura.github.io/files"
           :publishing-function org-publish-attachment)

          ("website" :components ("ensino" "images" ))))
#+END_SRC 
