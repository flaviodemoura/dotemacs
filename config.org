...
#+BEGIN_SRC emacs-lisp
  (require 'helm-books)
  (load "~/.emacs.d/org-books/org-books-get-details.el")
  (load "~/.emacs.d/org-books/org-books.el")
  (setq org-books-file "~/Dropbox/MyOrg/mbib.org")
  (setq org-capture-templates
            '(("b" "book memo" entry
               (file (concat org-directory "mbib.org"))
               "* %(helm-books)"
               )))
#+END_SRC
** Org Present
