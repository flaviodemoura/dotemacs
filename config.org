...
(setq org-directory "~/beorg/MyOrg")
...
(setq org-agenda-files '("~/beorg/MyOrg"))
...
(use-package org-roam
      ...
      :custom
      (org-roam-directory "/beorg/MyOrg/org-roam")
...
:ensure nil
:load-path "~/beorg/MyOrg/org-roam")
...
#+BEGIN_SRC emacs-lisp
  (use-package org-journal
    ...
    :ensure t
    :config
    (setq org-journal-dir "~/beorg/MyOrg/journal")
    (add-hook 'org-mode-hook 'turn-on-flyspell)
    :custom
